 ...
 * @author Steven
 */
public class ReporteBlockChain extends javax.swing.JInternalFrame {
    ...
    public ReporteBlockChain(CentralGUI Centralgui) {
        this.Centralgui = Centralgui;
        setName(Constantes.GUI_VENTANA_REPORTE_BlockChain);
        initComponents();
        cargarImagen();
    }
    
    public void cargarImagen(){
        String ruta = Centralgui.getLibraryManager().getImpresora().ImprimirBlockChain();
        try {   
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Reporte de BlockChain");
        setVisible(true);

        jScrollPane2.setBackground(java.awt.SystemColor.controlLtHighlight);
